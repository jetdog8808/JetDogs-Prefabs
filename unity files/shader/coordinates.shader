...
Shader "JetDog's Prefabs/coordinates" {
    Properties {
        ...
        _up ("up", Float ) = 2.5
        [MaterialToggle] _X ("X", Float ) = 0
        [MaterialToggle] _Z ("Z", Float ) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_3942 = 0.0;
                float node_3475 = 1.0;
                float _X_var = lerp( node_3942, node_3475, _X );
                float _Z_var = lerp( node_3942, node_3475, _Z );
                float node_3692_if_leA = step(_X_var,_Z_var);
                float node_3692_if_leB = step(_Z_var,_X_var);
                float coord = lerp((node_3692_if_leA*abs(objPos.b))+(node_3692_if_leB*abs(objPos.r)),abs(objPos.g),node_3692_if_leA*node_3692_if_leB);
                ...
                float node_127_if_leA = step(_X_var,_Z_var);
                float node_127_if_leB = step(_Z_var,_X_var);
                float node_5542_if_leA = step(objPos.r,node_3942);
                float node_5542_if_leB = step(node_3942,objPos.r);
                float node_3681_if_leA = step(_X_var,_Z_var);
                float node_3681_if_leB = step(_Z_var,_X_var);
                float node_769_if_leA = step(objPos.g,node_3942);
                float node_769_if_leB = step(node_3942,objPos.g);
                float node_9962_if_leA = step(_X_var,_Z_var);
                float node_9962_if_leB = step(_Z_var,_X_var);
                float node_7491_if_leA = step(objPos.b,node_3942);
                float node_7491_if_leB = step(node_3942,objPos.b);
                float negative = (lerp((node_127_if_leA*node_3942)+(node_127_if_leB*lerp((node_5542_if_leA*node_3942)+(node_5542_if_leB*node_3475),node_3942,node_5542_if_leA*node_5542_if_leB)),node_3942,node_127_if_leA*node_127_if_leB)+lerp((node_3681_if_leA*node_3942)+(node_3681_if_leB*node_3942),lerp((node_769_if_leA*node_3942)+(node_769_if_leB*node_3475),node_3942,node_769_if_leA*node_769_if_leB),node_3681_if_leA*node_3681_if_leB)+lerp((node_9962_if_leA*lerp((node_7491_if_leA*node_3942)+(node_7491_if_leB*node_3475),node_3942,node_7491_if_leA*node_7491_if_leB))+(node_9962_if_leB*node_3942),node_3942,node_9962_if_leA*node_9962_if_leB));
